...
export const Icon: React.FC<{ icon: IconComponent; className?: string }> = ({ icon: IconComponent, className }) => (
...
export const ChevronUp: IconComponent = (props) => (
...
export const ChevronsUpDown: IconComponent = (props) => (
...
export const FileDown: IconComponent = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22H9a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h6"/><path d="M12 18v-6"/><path d="m9 15 3 3 3-3"/><path d="M18 4h-2.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3H17"/><path d="M21 12.5a1.5 1.5 0 0 1-3 0V12a1.5 1.5 0 0 1 3 0Z"/></svg>
);
export const FileUp: IconComponent = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22H9a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h6"/><path d="M12 6v6"/><path d="m9 9 3-3 3 3"/><path d="M18 4h-2.5a1.5 1.5 0 0 0 0 3h1a1.5 1.5 0 0 1 0 3H17"/><path d="M21 12.5a1.5 1.5 0 0 1-3 0V12a1.5 1.5 0 0 1 3 0Z"/></svg>
);
...
export const MoreVertical: IconComponent = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="1"/><circle cx="12" cy="5" r="1"/><circle cx="12" cy="19" r="1"/></svg>
);
export const Filter: IconComponent = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"/></svg>
);
